...
- Twister: Remembers 3 targets' locations at the end of the castbar, then spawns twisters there that last for 5s. A twister triggers when someone is close to it, instantly killing everyone close by and doing a larger AoE with massive knockback
...
4s: Twister (repeats every 21s+)
8s: Death Sentence (repeats every 35s)
15s: Dreadknight (repeats every 40s)
...
- Finish off Hygieia, heal/shield up, then get into the Neurolinks and wait. The top enmity target should be alone in the A Neurolink, while everyone else stacks in the B Neurolink (the boss will combo Plummet right after Aetheric Profusion)
