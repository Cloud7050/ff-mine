...
- Twister: Remembers 3 targets' locations at the end of the castbar, then spawns twisters there that last for 5s. A twister triggers when someone is close by, instantly killing them and doing an AoE with massive knockback
- Unwoven Will: Stuns a target for the Dreadknight to fixate on. Used shortly after spawning it or if the current target dies. The stun lasts until the Dreadknight is killed

Dreadknight:\
Slowly moves towards the target stunned by the boss. Cannot be slept/bound, but can be stunned/heavied.

- Caber Toss: Instantly kills the target when it reaches them
...
- Finish off Hygieia, heal/shield up, then get into the Neurolinks and wait. The top enmity target should be alone in the A Neurolink, while everyone else stacks in the B Neurolink. When the boss reappears, she will combo Aetheric Profusion with Plummet
  - Check the enemy list to see who has aggro! If both tanks died earlier, it could even be a non-tank, in which case that person will be sacrificed to the combo. Otherwise, the MT should mit the combo in advance
  - Mixing up the top enmity target can easily cleave and kill the whole stack
- Do not leave the Neurolinks early. Wait for the damage, not the animation
  - If the MT dies to Aetheric Profusion, the boss is similarly going to cleave the stack. If the OT reacts fast, they could grab aggro and sprint away
