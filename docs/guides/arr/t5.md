...
She periodically spawns an Oviform under her.

- Liquid Hell: Now used 5 times in a row on the same target

Oviform:\
Marks a target with a triangular marker when it spawns, and homes in on them. Cannot be attacked.

- Hatch: Detonates in a small AoE that must be mitigated by standing in a Neurolink to survive. Used when it collides with anyone
