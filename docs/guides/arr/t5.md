...
**Phase 3**\
This is the adds phase during which the boss disappears for Divebombs. At the end, she reappears on D for Aetheric Profusion.
...
- The moment the boss disappears, everyone should run to C and stack tightly. Go as close to the edge as possible!
- When the Divebomb marker appears, immediately run to touch B, then go back to C for the next Divebomb
  - The idea is to bait the Divebombs into the ditch and out of the arena. As long as everyone stacks properly, what could otherwise be the hardest mechanic of the fight becomes very easy
...
- Finish off Hygieia, heal/shield up, then get into the Neurolinks and wait. The top enmity target should be alone in the A Neurolink, while everyone else stacks in the B Neurolink. When the boss reappears, she will combo Aetheric Profusion with Plummet
  - Check the enemy list to see who has aggro! If both tanks died, it could even be a non-tank, in which case that person will be sacrificed to the combo. Otherwise, the MT should mit the combo in advance
...
- Do not leave the Neurolinks early. Wait for the damage, not the animation
  - If the MT dies to Aetheric Profusion, the boss is similarly going to cleave the stack
