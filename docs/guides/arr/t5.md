...
- Twister: Remembers 3 targets' locations at the start of the castbar, then spawns twisters there that last for 5s. A twister triggers when someone is close by, instantly killing them and doing an AoE with massive knockback
...
Dreadknight:\
Slowly moves towards the target stunned by the boss.
