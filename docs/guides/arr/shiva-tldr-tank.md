...
Set waymarks as shown. The boss should be on A (mid), MT on B. OT's default state should be to stack behind the boss with everyone else, to aid with mechanics.
...
While the boss is equipping, MT should run through her to stack with the party. After equipping, the boss immediately turns to MT and uses Icebrand.
